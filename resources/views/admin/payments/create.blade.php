        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.payments.store") }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('total_received') ? 'is-invalid' : '' }}" type="number" name="total_received" id="total_received" value="{{ old('total_received', '0') }}" step="0.01" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('rider_received') ? 'is-invalid' : '' }}" type="number" name="rider_received" id="rider_received" value="{{ old('rider_received', '0') }}" step="0.01" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('office_received') ? 'is-invalid' : '' }}" type="number" name="office_received" id="office_received" value="{{ old('office_received', '0') }}" step="0.01" required>
